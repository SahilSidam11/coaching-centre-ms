    ...
    <Body>
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg leading-8 text-gray-600">
          Have a question, suggestion, or inquiry? We're here to help! Feel free
          ...
          <div className="sm:col-span-2">
            ...
            <div className="relative mt-2.5">
              <div className="absolute inset-y-0 left-0 flex items-center">
                ...
                >
                  <ChevronDownIcon
                    className="pointer-events-none absolute right-3 top-0 h-full w-5 text-gray-400 transition ease-out delay-100 duration-300 focus:outline-none hover:ring-2 hover:ring-inset hover:ring-indigo-500"
                    aria-hidden="true"
                  />
                  <option>US</option>
                  <option>CA</option>
              ...
              <input
                ...
                id="phone-number"
                autoComplete="tel"
                className="block w-full rounded-md border-0 px-3.5 py-2 pl-20 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 transition ease-out delay-100 duration-300 focus:outline-none hover:ring-2 hover:ring-inset hover:ring-indigo-500"
              />
            </div>
          </div>
          <div className="sm:col-span-2">
